...
exports.trimImages = function (files, options, callback) {
	...
	async.eachSeries(files, function (file, next) {
		...
		execFile('convert', [scale, fuzz, ' -define png:exclude-chunks=date "', file.originalPath, '" -bordercolor transparent -border 1 -trim "', file.path, '"'], next);
	}, callback);
};
...
exports.getImagesSizes = function (files, options, callback) {
	...
	execFile('identify ', [filePaths.join(' ')], function (err, stdout) {
